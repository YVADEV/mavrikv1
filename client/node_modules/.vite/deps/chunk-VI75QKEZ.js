import {
  Popper,
  Portal
} from "./chunk-PPQZQWH4.js";
import {
  useCompoundItem
} from "./chunk-USQ4XM5U.js";
import {
  useButton
} from "./chunk-WYEMO75U.js";
import {
...
function useNumberInput(parameters) {
  ...
  const [value, setValue] = React13.useState(valueProp != null ? valueProp : defaultValueProp);
...
var _excluded6 = ["className", "defaultValue", "disabled", "error", "id", "max", "min", "onBlur", "onInputChange", "onFocus", "onChange", "placeholder", "required", "readOnly", "shiftMultiplier", "step", "value", "slotProps", "slots"];
...
var NumberInput = React14.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime14.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime13.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime13.jsx)(IncrementButton, _extends({}, incrementButtonProps)), (0, import_jsx_runtime13.jsx)(Input3, _extends({}, inputProps))]
  }));
});
...
var Option = React17.memo(React17.forwardRef(function Option2(props, forwardedRef) {
...
var Popup = React19.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
...
function useSelect(props) {
  ...
  const optionValues = React20.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React20.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React20.useCallback((valueToCheck) => {
    var _option$disabled;
    const option = getOptionByValue(valueToCheck);
    return (_option$disabled = option == null ? void 0 : option.disabled) != null ? _option$disabled : false;
  }, [getOptionByValue]);
  const stringifyOption = React20.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const controlledState = React20.useMemo(() => ({
    selectedValues: value,
    open: openProp
  }), [value, openProp]);
  const getItemId = React20.useCallback((itemValue) => {
    var _options$get;
    return (_options$get = options.get(itemValue)) == null ? void 0 : _options$get.id;
  }, [options]);
  const handleSelectionChange = React20.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React20.useCallback((event, newValue) => {
    onHighlightChange == null ? void 0 : onHighlightChange(event, newValue != null ? newValue : null);
  }, [onHighlightChange]);
  const handleStateChange = React20.useCallback((event, field, fieldValue) => {
    if (field === "open") {
  ...
  const useListParameters = {
    ...
    reducerActionContext: React20.useMemo(() => ({
      multiple
    }), [multiple]),
    items: optionValues,
  ...
  const getOptionMetadata = React20.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
  ...
  const contextValue = React20.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
var _excluded10 = ["areOptionsEqual", "autoFocus", "children", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "listboxId", "listboxOpen", "multiple", "name", "required", "onChange", "onListboxOpenChange", "getOptionAsString", "renderValue", "slotProps", "slots", "value"];
...
var Select = React22.forwardRef(function Select2(props, forwardedRef) {
...
var Slider = React24.forwardRef(function Slider2(props, forwardedRef) {
...
function useSnackbar(parameters) {
  ...
  const timerAutoHide = React25.useRef();
  React25.useEffect(() => {
    if (!open) {
      return void 0;
    }
...
var Snackbar = React26.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var Switch = React28.forwardRef(function Switch2(props, forwardedRef) {
...
var TablePaginationActions = React29.forwardRef(function TablePaginationActions2(props, forwardedRef) {
...
var TablePagination = React30.forwardRef(function TablePagination2(props, forwardedRef) {
...
function useTabs(parameters) {
  ...
  const onSelected = React31.useCallback((event, newValue) => {
    setValue(newValue);
    onChange == null ? void 0 : onChange(event, newValue);
  }, [onChange, setValue]);
  const {
  ...
  const tabIdLookup = React31.useRef(() => void 0);
  const getTabPanelId = React31.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React31.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React31.useCallback((lookupFunction) => {
...
var TabsContext = React32.createContext(null);
if (true) {
...
var Tabs = React34.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabPanel(parameters) {
  ...
  const metadata = React35.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
var TabPanel = React36.forwardRef(function TabPanel2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React37.useCallback((tabValue) => {
    var _subitems$get;
  ...
  const getTabElement = React37.useCallback((tabValue) => {
  ...
  const handleChange = React37.useCallback((event, newValue) => {
    var _newValue$;
    onSelected(event, (_newValue$ = newValue[0]) != null ? _newValue$ : null);
  }, [onSelected]);
  const controlledProps = React37.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React37.useCallback((item) => {
  ...
  const contextValue = React37.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
var TabsList = React39.forwardRef(function TabsList2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
function useTab(parameters) {
  ...
  const tabRef = React40.useRef(null);
  const id = useId(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
  ...
  const tabMetadata = React40.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var _excluded19 = ["action", "children", "value", "disabled", "onChange", "onClick", "onFocus", "slotProps", "slots"];
...
var Tab = React41.forwardRef(function Tab2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled = false,
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React43.useRef(false);
  const firstFocus = React43.useRef(true);
  const inputRef = React43.useRef(null);
  const listboxRef = React43.useRef(null);
  const [anchorEl, setAnchorEl] = React43.useState(null);
  const [focusedTag, setFocusedTag] = React43.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React43.useRef(defaultHighlighted);
  ...
  const resetInputValue = React43.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React43.useState(true);
  ...
  const syncHighlightedIndex = React43.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React43.useRef(false);
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VI75QKEZ.js.map

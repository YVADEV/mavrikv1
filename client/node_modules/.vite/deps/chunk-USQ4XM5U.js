...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = (_React$useContext = React2.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
  const {
...
var MenuItem = React3.forwardRef(function MenuItem2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
...
//# sourceMappingURL=chunk-USQ4XM5U.js.map

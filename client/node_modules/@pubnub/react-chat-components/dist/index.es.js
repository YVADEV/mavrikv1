...
import React__default, { useState, useEffect, useRef, createElement, createContext, useContext, useReducer, useDebugValue, useCallback, Component, useMemo, cloneElement } from 'react';
...
var Chat = /** @class */ (function (_super) {
    ...
    Chat.prototype.render = function () {
        return (React__default.createElement(Provider, null,
...
var useMessageInputCore = function (props) {
    ...
    var _a = useState(draftMessage || ""), text = _a[0], setText = _a[1];
    var _b = useState(null), file = _b[0], setFile = _b[1];
    var _c = useState(false), typingIndicatorSent = _c[0], setTypingIndicatorSent = _c[1];
...
var useMessageListCore = function (props) {
    ...
    var onError = onErrorObj.function;
    var _c = useState(true), scrolledBottom = _c[0], setScrolledBottom = _c[1];
    var _d = useState(0), unreadMessages = _d[0], setUnreadMessages = _d[1];
    var _e = useState(false), fetchingMessages = _e[0], setFetchingMessages = _e[1];
    var _f = useState(null), reactingToMessage = _f[0], setReactingToMessage = _f[1];
    var _g = useState(false), emojiPickerShown = _g[0], setEmojiPickerShown = _g[1];
    // https://pubnub.atlassian.net/browse/UI-1843
    var _h = useState({}), initMessagesLoaded = _h[0], setInitMessagesLoaded = _h[1];
    /*
    /* Helper functions
    */
    ...
    /* Commands
    */
    var fetchFileUrl = useCallback(function (envelope) {
    ...
    var fetchHistory = useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
...
var MessageInput = function (props) {
    ...
    var _b = useState(false), emojiPickerShown = _b[0], setEmojiPickerShown = _b[1];
    ...
    */
    var renderFileUpload = function () {
        ...
        return (React__default.createElement(React__default.Fragment, null, file ? (React__default.createElement("button", { "aria-label": removeTitle, title: removeTitle, onClick: handleRemoveFile },
            React__default.createElement(SvgXCircle, null))) : (React__default.createElement(React__default.Fragment, null,
            React__default.createElement("button", { "aria-label": addTitle, title: addTitle, onClick: function () { return fileRef.current.click(); } }, fileUpload === "image" ? React__default.createElement(SvgImage, null) : React__default.createElement(SvgFile, null)),
            React__default.createElement("input", { accept: fileUpload === "image" ? "image/*" : "*", className: "pn-msg-input__fileInput", "data-testid": "file-upload", id: "file-upload", onChange: handleFileChange, ref: fileRef, type: "file" })))));
    };
    var renderEmojiPicker = function () {
        var title = "Add an emoji";
        return (React__default.createElement(React__default.Fragment, null,
            React__default.createElement("button", { "aria-label": title, title: title, onClick: function () { return setEmojiPickerShown(true); } },
                React__default.createElement(SvgEmoji, null)),
            emojiPickerShown && (React__default.createElement("div", { className: "pn-msg-input__emoji-picker", ref: pickerRef, style: actionsAfterInput ? { left: "unset" } : { right: "unset" } }, React__default.cloneElement(emojiPicker, { onEmojiSelect: handleEmojiInsertion })))));
    };
    var renderActions = function () { return (React__default.createElement("div", { className: "pn-msg-input__icons" },
        React__default.createElement("div", { className: "pn-msg-input__emoji-toggle" }, !disabled && emojiPicker && renderEmojiPicker()),
        !disabled && fileUpload && renderFileUpload(),
        extraActionsRenderer && extraActionsRenderer())); };
    return (React__default.createElement("div", { className: "pn-msg-input pn-msg-input--".concat(theme, " ").concat(disabled ? "pn-msg-input--disabled" : "") },
        React__default.createElement("div", { className: "pn-msg-input__wrapper" },
            !actionsAfterInput && renderActions(),
            React__default.createElement("textarea", __assign({}, otherTextAreaProps, { className: "pn-msg-input__textarea", "data-testid": "message-input", disabled: disabled || !!file, onChange: handleInputChange, onKeyPress: handleKeyPress, placeholder: placeholder, ref: inputRef, rows: 1, value: text })),
            actionsAfterInput && renderActions(),
            !hideSendButton && !disabled && (React__default.createElement("button", { "aria-label": "Send", className: "pn-msg-input__send ".concat(isValidInputText() && "pn-msg-input__send--active"), disabled: loader || disabled, onClick: handleSendClick, title: "Send" }, loader ? React__default.createElement(SvgSpinner, null) : sendButton)))));
};
...
var MessageListItem = React__default.memo(Item, function (prev, next) {
...
function Item(_a) {
    ...
    return (React__default.createElement("div", { className: "pn-msg ".concat(currentUserClass), key: envelope.timetoken },
        messageRenderer && (filter ? filter(envelope) : true) ? (messageRenderer({ message: envelope, user: user, time: time, isOwn: isOwn, editedText: editedText })) : (React__default.createElement(React__default.Fragment, null,
            ...
            React__default.createElement("div", { className: "pn-msg__main" },
                React__default.createElement("div", { className: "pn-msg__content" },
                    ...
                    (message === null || message === void 0 ? void 0 : message.text) &&
                        (bubbleRenderer && (filter ? filter(envelope) : true) ? (bubbleRenderer({ message: envelope, user: user, time: time, isOwn: isOwn, editedText: editedText })) : (React__default.createElement("div", { className: "pn-msg__bubble" }, editedText || (message === null || message === void 0 ? void 0 : message.text))))),
                React__default.createElement("div", { className: "pn-msg__extras" },
                    file && file.name ? (fileRenderer ? (fileRenderer(file)) : (React__default.createElement("div", { className: "pn-msg__file" }, /\.(svg|gif|jpe?g|tiff?|png|webp|bmp)$/i.test(file.name) ? (React__default.createElement("img", { alt: file.name, className: "pn-msg__image", src: file.url, onLoad: function () {
                            if (scrolledBottom)
                                scrollToBottom();
                        ...
                        React__default.createElement("a", { className: "pn-msg__nonImage", href: file.url, target: "_blank", rel: "noopener noreferrer", download: true },
                            file.name,
                            React__default.createElement(SvgDownload, { className: "pn-msg__downloadIcon" }))))))) : null,
                    enableReactions && reactions ? (React__default.createElement("div", { className: "pn-msg__reactions" }, Object.entries(reactions)
                        .sort(function (_a, _b) {
                        var a = _a[1];
                        var b = _b[1];
        ...
        React__default.createElement("div", { className: "pn-msg__actions" },
            ...
            reactionsPicker && (message === null || message === void 0 ? void 0 : message.type) !== "welcome" ? (React__default.createElement("div", { className: "pn-msg__reactions-toggle", title: "Add a reaction", onClick: function (e) {
                    emojiPickerShown && reactingToMessage === envelope.timetoken
                        ? setEmojiPickerShown(false)
                        : handleOpenReactions(e, envelope.timetoken);
                } },
                React__default.createElement(SvgEmoji, null))) : null)));
}
    ...
    */
    ...
    return (React__default.createElement("div", { className: "pn-msg-list pn-msg-list--".concat(theme) },
        ...
        React__default.createElement("div", { className: "pn-msg-list-scroller", onScroll: props.onScroll, ref: listRef },
            React__default.createElement("span", { ref: spinnerRef, className: "pn-msg-list__spinner" }, !!props.fetchMessages && !paginationEnd && React__default.createElement(SvgSpinner, null)),
            React__default.createElement("div", { className: "pn-msg-list__spacer" }),
            (!props.fetchMessages || (!fetchingMessages && !messages.length)) &&
                welcomeMessages &&
                welcomeMessages.map(function (m) { return (React__default.createElement(MessageListItem, __assign({ key: m.timetoken, envelope: m }, messageItemProps))); }),
            messages &&
                messages.map(function (m) { return (React__default.createElement(MessageListItem, __assign({ key: m.timetoken, envelope: m }, messageItemProps))); }),
            props.children,
            React__default.createElement("div", { className: "pn-msg-list__bottom-ref" },
                React__default.createElement("div", { ref: endRef })),
            props.reactionsPicker && (React__default.createElement("div", { className: "pn-msg-list__emoji-picker ".concat(!emojiPickerShown && "pn-msg-list__emoji-picker-hidden"), ref: pickerRef }, cloneElement(props.reactionsPicker, { onEmojiSelect: handleEmojiInsertion }))))));
};
...
export { ChannelList, Chat, ChatInternal, CurrentChannelAtom, CurrentChannelMessagesAtom, CurrentChannelPaginationAtom, CurrentChannelTypingIndicatorAtom, ErrorFunctionAtom, MemberList, MessageInput, MessageList, MessagesAtom, MissingUserCallbackAtom, PaginationAtom, RequestMissingUserAtom, RetryFunctionAtom, SubscribeChannelGroupsAtom, SubscribeChannelsAtom, ThemeAtom, TypingIndicator, TypingIndicatorAtom, TypingIndicatorTimeoutAtom, UsersMetaAtom, getNameInitials, getPredefinedColor, isFilePayload, useChannelListCore, useChannelMembers, useChannels, useIntersectionObserver, useMemberListCore, useMessageInputCore, useMessageListCore, useMessages, useMutationObserver, useOuterClick, usePresence, usePrevious, useResizeObserver, useSubscribe, useTypingIndicatorCore, useUser, useUserMemberships, useUsers };
